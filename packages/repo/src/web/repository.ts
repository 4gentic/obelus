...
const diffHunksStub: DiffHunksRepo = {
  ...
  deleteDeepReviewBlocks: () => Promise.reject(new NotSupportedError("diffHunks")),
  ...
  acceptAllInSession: () => Promise.reject(new NotSupportedError("diffHunks")),
  rejectAllInSession: () => Promise.reject(new NotSupportedError("diffHunks")),
