...
export default function PdfPane({ doc, paperId }: Props): JSX.Element {
  ...
  // Resolve the actual scroll element (`.project-shell__center`) once mounted
  // so the margin gutter and the marks list can read scrollTop and call
  // scrollToAnnotation against the same coordinate space the adapter used.
