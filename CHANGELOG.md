...
All notable changes to Obelus are documented here. This file is generated from Conventional Commits by [release-please](https://github.com/googleapis/release-please) and follows [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

## [0.1.1](https://github.com/4gentic/obelus/compare/v0.1.0...v0.1.1) (2026-04-21)


### Features

* **bundle-builder:** reshape review prompt as a peer-review letter ([ef3ba36](https://github.com/4gentic/obelus/commit/ef3ba362aa9c88108ee794a3157d34d802c077fa))
...
* **web:** kind-aware bundle export with per-tab next-step hint ([d674bfd](https://github.com/4gentic/obelus/commit/d674bfdd50e2fc6b6a217a8e5262cd51a8e8c7e4))
