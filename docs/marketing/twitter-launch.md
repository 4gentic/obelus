...
5/ In your paper's repo, the Claude Code plugin takes over. `/obelus:apply-review bundle.json` detects whether your source is LaTeX, Markdown, or Typst, plans a minimal-diff fix for each mark, and waits for your confirmation before writing anything.
