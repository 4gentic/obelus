...
- `CODE_OF_CONDUCT.md` — Contributor Covenant 2.1, contact `security@obelus.app`.
...
- `CODE_OF_CONDUCT.md` — Contributor Covenant 2.1 verbatim, with the contact line set to `security@obelus.app`.
