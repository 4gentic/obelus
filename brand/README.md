...
| `lockup.svg` | Mark + wordmark. Wordmark is Newsreader italic, outlined (no webfont dependency — renders identically on github.com, social cards, and any embed surface). Intended for app header and landing hero. |
