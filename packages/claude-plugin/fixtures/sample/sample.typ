#set document(title: "On the Scalability of Transformer Attention", author: "A. N. Other")
#set page(paper: "a4", margin: 1in)
#set text(font: "New Computer Modern", size: 11pt)

#align(center)[
  #text(size: 16pt, weight: "bold")[On the Scalability of Transformer Attention]

  A. N. Other --- April 2026
]
