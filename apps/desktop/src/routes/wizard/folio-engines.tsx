  ...
  return (
    <article className="folio">
      ...
      <p className="folio__body">
        Obelus can compile your source into PDF without touching your system. If you already have a
        TeX distribution or Typst on your machine, Obelus will find them. If not, it can install a
        self-contained copy now — or later, from Settings.
      </p>
      <div className="folio__engines">
