...
.claude/agents/     Project personas (Typesetter / Archivist / Compositor / Scribe / Proofreader).
fixtures/sample/    Sample paper in .tex / .md / .typ + rendered PDF — used by plugin e2e.
